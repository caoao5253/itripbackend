...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action=${pageContext.request.contextPath}/api/pay method=post
			target="_blank">
		...
		<form name=tradequery action=${pageContext.request.contextPath}/api/query method=post
			target="_blank">
		...
		<form name=traderefund action=WEB-INF/jsp/alipay.trade.refund.jsp method=post
			  target="_blank">
		...
		<form name=traderefundquery
			  action=WEB-INF/jsp/alipay.trade.fastpay.refund.query.jsp method=post
			  target="_blank">
		...
		<form name=tradeclose action=WEB-INF/jsp/alipay.trade.close.jsp method=post
			  target="_blank">
